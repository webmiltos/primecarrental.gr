<section class="hidden-overflow">
    <div class="first-image-text-outside-wrapper sec ver3">
        <div class="mid-container first-image-text-wrapper sec ver3">
            <div class="first-image-text-wrap">
                <div class="image-text-content-wrapper">
                    ...
                    <?php elseif( $titleCat == 'h2' ): ?>
                        <h2 class="image-text-title third-color margin-bottom-small show-on-scroll slide-right" style="<?php the_sub_field('title_custom_css'); ?>">
                            <?php the_sub_field('title'); ?>
                        </h2>
                ...
                <div class="first-image-text-left-wrap full-img">
                    <?php 
