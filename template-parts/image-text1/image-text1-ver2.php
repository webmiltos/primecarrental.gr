...
?>
<section class="first-image-text-outside-wrapper ver2  <?php echo $reverted ? ' reverted' : '' ;?>">
    <div class="primary-light-color-bg img-txt-bg-wrap"></div>
    <div class="mid-container first-image-text-wrapper ver2">
        <div class="first-image-text-wrap">
            ...
            <div class="first-image-text-left-wrap">
                ...
                if( $image ):?>
                    <div class="first-image-text-main-image show-on-scroll slide-left" style="transition-delay:.1s;">
                ...
                $size = 'medium_large'; // (thumbnail, medium, large, full or custom size)
                if( $image ):?>
                    <div class="first-image-text-alt-image show-on-scroll slide-left" style="transition-delay:.3s;">
                        <?php echo wp_get_attachment_image( $image['id'], $size ); ?>
                    </div>
                <?php endif; ?>
            </div>
