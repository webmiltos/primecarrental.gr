...
?>
<section class="mid-container first-image-text-wrapper ver1 <?php echo $reverted ? ' reverted' : ''; ?>">
    <div class="first-image-text-wrap">
        ...
        <div class="first-image-text-left-wrap">
            ...
            if ($image) : ?>
                <div class="first-image-text-alt-image">
                    <?php echo wp_get_attachment_image($image['id'], $size); ?>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="image-text-content-wrapper small-container">
            <span class="cali pretitle third-color image-text-pretitle margin-bottom-small show-on-scroll slide-right inter" style="<?php the_sub_field('pretitle_custom_css'); ?>">
