...
<section class="product-categories-section v2">
    <div class="intro-fleet">
        ...
        <span class="main-text text-color center image-text-text medium-width show-on-scroll"><?php the_sub_field('text'); ?></span>
    </div>

    <div class="three-vehicle-types">
        ...
        <ul class="fleet-collection-wrap mid-container fleet-wrapper basic-styling three-types">
            ...
            <?php if (get_sub_field('product_repeater')) : ?>
                <?php while (the_repeater_field('product_repeater')) : ?>
                    <li class="single-fleet-wrap fleet-single-wrap <?php echo $btnStyle; ?>">
