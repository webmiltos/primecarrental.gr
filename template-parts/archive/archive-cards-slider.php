<section class="blocks-outside-wrapper ver3 blogs cards-slider">
    <div class="blocks-wrapper ver3">
        ...
        if ($my_query->have_posts()) { ?>
            <?php $time = 0.1; ?>
            <div class="blocks-wrap container archive-swiper-container">
                <div class="swiper-wrapper">
                    ...
                    ?>
                        ...
                        <a class="block-box-wrap swiper-slide show-on-scroll slide-up" href="<?php echo get_permalink(); ?>" style="transition-delay:<?php echo $time; ?>s">
                            <div class="block-box-image">
                                <?php echo wp_get_attachment_image($firstImg['id'], 'large'); ?>
                            </div>
                            <div class="block-box-content">
                                <span class="margin-bottom blog-arch-title white secondary-font bold"><?php the_title(); ?></span>
    ...
    <?php if (get_sub_field('button_link')) : ?>
        ...
        <div class="button-wrapper center">
            <a class="border-btn-wrap black hover-black <?php echo $btnStyle; ?>" href="<?php the_sub_field('button_link'); ?>">
