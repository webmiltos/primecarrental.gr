<section class="blocks-outside-wrapper ver3 blogs cards2">
    <div class="blocks-wrapper ver3">
        <div class="top-center-wrapper">
            ...
            <?php endif; ?>
            <h2 class="no-font">latitude text</h2>
            <h3 class="no-font">latitude text</h3>
        </div>
    ...
    <?php if (get_sub_field('button_link')) : ?>
        ...
        <div class="button-wrapper center">
            <a class="border-btn-wrap white hover-black <?php echo $btnStyle; ?>" href="<?php the_sub_field('button_link'); ?>">
