<section class="blocks-outside-wrapper ver1">
    <div class="blocks-wrapper ver1">
                    ...
                    ?>
                        ...
                        ?>
                            <a class="block-box-wrap show-on-scroll slide-up" style="transition-delay:<?php echo $time; ?>s" href="<?php echo esc_url($permalink); ?>">
                                ...
                                <div class="block-box-content">
                                    <span class="margin-bottom box-title bold-weight white"><?php the_sub_field('title'); ?></span>
